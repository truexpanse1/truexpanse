-- AI Mentor Coach - Supabase Migration
...
CREATE INDEX IF NOT EXISTS idx_influencers_domain ON influencers(domain_id);
...
CREATE INDEX IF NOT EXISTS idx_assessments_domain ON assessments(domain_id);
...
CREATE INDEX IF NOT EXISTS idx_coaching_plans_user ON coaching_plans(user_id);
CREATE INDEX IF NOT EXISTS idx_coaching_plans_assessment ON coaching_plans(assessment_id);
...
CREATE INDEX IF NOT EXISTS idx_daily_tasks_plan ON daily_tasks(coaching_plan_id);
...
CREATE INDEX IF NOT EXISTS idx_eod_reflections_user_date ON eod_reflections(user_id, date);
