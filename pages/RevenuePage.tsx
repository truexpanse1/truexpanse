...
const RevenuePage: React.FC<RevenuePageProps> = ({ transactions, onSaveTransaction, onDeleteTransaction, selectedDate, onDateChange }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (!clientName || !product || isNaN(numericAmount) || numericAmount < 0) { alert('Please fill out all fields with valid data.'); return; }
